...
The app can collect from The Odds API, Polymarket Gamma, Kalshi market data, and RSS news signals.
...
- `WCPROB_NEWS_ENABLED`: Set to `false` to disable RSS news signal collection. Defaults to `true`.
- `WCPROB_NEWS_URL`: RSS URL used for news-signal country mention pooling.
